...
#define enc28j60_reset	GPIOA, GPIO_Pin_3
#define enc28j60_select()  GPIO_ResetBits(GPIOA, GPIO_Pin_4)
#define enc28j60_release() GPIO_SetBits(GPIOA, GPIO_Pin_4)
...
void enc28j60_soft_reset()
{
   ...
   DelayMs(1); //Ожидание окончания инициализации ENC28J60
}
...
void enc28j60_init(uint8_t *macadr)
{
	...
	enc28j60_release();        //CS == 1
	GPIO_SetBits(enc28j60_reset);
   GPIO_ResetBits(enc28j60_reset);
	GPIO_SetBits(enc28j60_reset);
